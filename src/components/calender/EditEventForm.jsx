...
const EditEventForm = ({ event, onSubmit }) => {
    ...
    const [NofVolunteers, setNofVolunteers] = useState(event.extendedProps.details.NofVolunteers);
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex flex-lg-row flex-column gap-lg-4 gap-3 mb-3">
                <div className="input-group border">
                    ...
                    <input type="text" placeholder="# of Volunteers" value={NofVolunteers}
                           onChange={(e) => setNofVolunteers(e.target.value)} className='form-control'/>
                </div>
                <SelectDropdown
            ...
            <div className="w-100 mb-3">
                <textarea className='form-control border ps-3' placeholder='Description' value={details}
