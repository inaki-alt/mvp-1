...
const filteringOptions = ["Oldest", "Newest", "Replied", "Snoozed", "Ascending", "Descending", "Mute Conversation", "Block Conversation", "Delete Conversation"]
...
const chatUsers = [
  {
    ...
    active_time: "Last seen 3:30 PM",
    is_active: { color: "#17c666" },
  ...
  },
  {
    ...
    active_time: "Last seen 3:32 PM",
    is_active: { color: "#ea4d4d" },
    ...
    <div className={`content-sidebar content-sidebar-xl ${sidebarOpen ? "app-sidebar-open" : ""}`}>
      <PerfectScrollbar>
        ...
        <div className="content-sidebar-body">
          ...
          >
            {
              chatUsers.map(({ id, user_name, active_time, is_active, is_message_read }) => {
                return (
                  <div
                    key={id}
                  ...
                  >
                    {
                        <div className="text-white avatar-text user-avatar-text">{user_name.charAt(0)}</div>
                    }
                    ...
                    <div className="ms-3 item-desc">
                      ...
                      <p className={`fs-12 fw-semibold mt-2 mb-0 text-truncate-2-line ${is_message_read ? "" : "text-dark"}`}>
                        Hey there! This is a quick preview of our latest conversation.
                      </p>
                    </div>
                  </div>
                )
