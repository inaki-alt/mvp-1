                        ...
                        <div className="card-body task-header d-md-flex align-items-center justify-content-between">
                            <div className="me-4">
                                <h4 className="mb-4 fw-bold d-flex">
                                    <span className="text-truncate-1-line">Altruence || CRM Applications &amp; Admin Dashboar <span className="badge bg-soft-primary text-primary mx-3">In Prograss</span></span>
                                </h4>
