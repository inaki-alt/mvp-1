...
const MegaMenu = () => {
  ...
  return (
    <div className="HideComponent dropdown nxl-h-item nxl-mega-menu">
      <a href="#" className="btn btn-light-brand" data-bs-toggle="dropdown" data-bs-auto-close="outside"> Megaaaaa Menu </a>
