...
const customerListTagsOptions = [
    ...
    { value: 'team', label: 'Team', color: '#000000' },
    ...
    { value: 'wholesale', label: 'Wholesale', color: '#000000' },
...
const leadsGroupsOptions = [
    ...
    { value: "group-c", label: "Group-C", color: "#000000" },
    ...
    { value: "group-i", label: "Group-I", color: "#000000" },
    { value: "group-j", label: "Group-J", color: "#ea4d4d" },
    { value: "group-k", label: "Group-K", color: "#41b2c4" },
]

const taskStatusOptions = [
    { value: 'inprogress', label: 'Inprogress', color: '#000000' },
...
const taskPriorityOptions = [
    { value: 'low', label: 'Low', color: '#000000' },
...
const projectStatusOptions = [
    { value: "in-projress", label: "In Projress", color: "#000000" },
...
const projectBillingOptions = [
    { value: "fixed-rate", label: "Fixed Rate", color: "#000000" },
