...
export const profileActivityData2 = [
    {
        ...
        description: 'Altruence is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
    ...
    {
        color: 'danger',
        title: 'Event start soon #Altruence',
        description: 'Altruence is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
            {
                users: [
